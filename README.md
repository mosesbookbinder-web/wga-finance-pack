...
- `reports/finance_smoke_v1.run_bundle.json`
- `reports/finance_smoke_v1.finance_smoke_report.json`
- `reports/04_REPORT_finance_smoke_v1.json`
- `docs/02_RUNBUNDLE_finance_smoke_v1_SUMMARY.txt`
- `docs/finance_provenance_20260101T163628Z.txt`
...
Review the included run bundle, report artifacts, receipts, and manifest. Recompute SHA-256 values for the included files to confirm file-bytes identity.
